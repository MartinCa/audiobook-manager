...
export const SignalREvents = {
  ...
  SeriesRefreshApplyProgress: "SeriesRefreshApplyProgress",
  SeriesRefreshApplyComplete: "SeriesRefreshApplyComplete",
  SeriesMissingBookApplyProgress: "SeriesMissingBookApplyProgress",
  SeriesMissingBookApplyComplete: "SeriesMissingBookApplyComplete",
  SeriesDeleteProgress: "SeriesDeleteProgress",
  SeriesDeleteComplete: "SeriesDeleteComplete",
  ...
  MetadataApplyProgress: "MetadataApplyProgress",
  MetadataApplyComplete: "MetadataApplyComplete",
...
export const OperationKeys = {
  ...
  seriesRefreshApply: "series-refresh-apply",
  seriesMissingBookApply: "series-missing-book-apply",
