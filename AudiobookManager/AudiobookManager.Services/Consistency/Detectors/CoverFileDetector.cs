...
public sealed class CoverFileDetector : IBookConsistencyIssueDetector
{
    public IEnumerable<BookConsistencyIssue> Detect(AudiobookCheckContext context)
    {
        ...
        {
            yield return BookConsistencyIssueFactory.Create(context.Audiobook.Id, BookConsistencyIssueType.MissingCoverFile,
